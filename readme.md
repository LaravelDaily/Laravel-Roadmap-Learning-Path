...
Rus ordusu [evleri, hastaneleri ve anaokullarını bombaladığı için] Ukrayna'da şu anda neler olduğunu görmek korkunç (https://twitter.com/DavidCornDC/status/1501620037785997316). 

Oradaki insanlara nasıl yardım edebileceğinizi öğrenmek için lütfen [supportukrainenow.org](https://supportukrainenow.org/) adresini ziyaret edin. Herkese duyurun.

Ve eğer Rusya'daysanız ve bu savaşa karşıysanız, lütfen protestonuzu bir şekilde ifade edin. Bunun için cezalandırılabileceğinizi biliyorum ama siz de o masum insanların umutlarından birisiniz.

---

# Laravel Eğitimi Yol Haritası

Bu depo, ilgili bağlantılarla birlikte adım adım öğrenilecek Laravel konularının **sıralı** listesini içerir.

Bir konu, bağlantı veya başka bir öneri eklemek istiyorsanız, lütfen Sorunlar veya Çekme İstekleri açın.

**Uyarı**: Bu içerik [QuickAdminPanel](https://quickadminpanel.com?utm_source=github&utm_campaign=roadmap) ile oluşturulan bir adminpanele doldurulmuştur - işte [Youtube'da bu işlemin video demosu](https://www.youtube.com/watch?v=i2ElUDUDRms). QuickAdminPanel'i satın alarak bu Yol Haritası gibi ücretsiz girişimlerimi desteklemiş olursunuz.

--- 

## Başlangıç Seviye Laravel
İlk basit Laravel projenizi oluşturun
...
| **Tam İşlevli Basit CRUD Uygulaması** ||
...
### Başlangıç Demo-Projesi: Kişisel Blog

Bu Başlangıç seviyesine ulaşmak için [bu kişisel blog projesi] (https://github.com/LaravelDaily/Laravel-Roadmap-Beginner-Challenge) gibi bir şey oluşturarak pratik yapmanız gerekir.

Yukarıdaki deponun içinde, birkaç örnek çözümle birlikte görevin tüm ayrıntılarını bulacaksınız.
...
| ----- | ----- |
| **Gelişmiş Routing Yapısı** | :clapper: [Laravel: 8 Tips for Advanced Routing](https://www.youtube.com/watch?v=_BIhuX8owTo) <br> :clapper: [More videos](videos/routing-advanced.md) <br> |
...
| **Dosya Yükleme İşlemlerid** |:capital_abcd: [File Uploads in Laravel](https://laraveldaily.com/course/laravel-file-uploads?utm_source=github&utm_campaign=roadmap) <br>|
...
| **E-Posta Gönderimi** | :clapper: [Laravel: 3 Ways to Send a Welcome Email (Controller vs Observer vs Events)](https://www.youtube.com/watch?v=ZWzH6SOzjhI) |
